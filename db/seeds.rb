...
VirtualChart.create([ 
    {date: Date.today, note: "This patient had the most interesting breakthrough and accurately self diagnosed themself. Time for me to retire. ", patient_id: 1, provider_id: 1 }, 
    {date: Date.today, note: "today I turn in my final project for flatiron!", patient_id: 3, provider_id: 1},
